		...
		<div class="container">
			...
			<div style="width: 600px; margin: 0 auto; text-align: center ; ">
					...
					<c:if test="${Uname != null}">
						<p> <b>${Uname}</b>,您的旅宿資料 <b>${hotel.hname}</b>已更新</p>
					</c:if>
					
					<c:if test="${duser != null}">
						<p><b>${duser}</b>,您的旅宿資料<b>${dhotel}</b>已刪除</p>
					</c:if>
	
						<table style= "margin: 0 auto; ">
							

							<c:if test="${user.utel != null}">
								<tr>
									<td>您的姓名:${user.uname}</td>
								</tr>


								<tr>
									<td>您的電話:${user.utel}</td>
								</tr>
								<tr>
									<td>您的電郵:${user.uemail}</td>
								</tr>
							</c:if>


							<tr>
								<td>旅宿名稱:${hotel.hname}</td>
							</tr>
							<tr>
								<td>旅宿電話:${hotel.htel}</td>
							</tr>
							<tr>
								<td>旅宿電郵:${hotel.hemail}</td>
							</tr>
							<tr>
								<td>旅宿官網:${hotel.hweb}</td>
							</tr>
							<tr>
								<td>旅宿地址:${hotel.haddr}</td>
							</tr>
							<tr>
								<td>旅宿最低價:${hotel.hprice}</td>
							</tr>
