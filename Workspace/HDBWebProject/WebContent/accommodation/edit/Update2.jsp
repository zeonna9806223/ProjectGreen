					...
					<form name="form1"
						...
						<div>
							<label>姓名:<input type="text" name="Uname" id="name"
								disabled required value="${sessionScope.LoginOK.memberName}" onblur="checkName()"
								onkeydown="keyDown('check1')"></label><br> <span id="check1"></span>
						</div>
						<div>
							<label>電話:<input type="tel" name="Utel" disabled
								required value="${sessionScope.LoginOK.memberCellPhone}"  maxlength="10"></label><br>
<%-- 								required value="${sessionScope.LoginOK.memberCellPhone}" pattern="[0-9]{10}" maxlength="10"></label><br> --%>
						...
						<div>
							<label>電郵:<input type="email" name="Uemail"
								disabled required value="${sessionScope.LoginOK.memberCellPhone}"></label><br>
						</div>
					...
					<fieldset>
						...
						<div>
							<label>電話: <input type="tel" name="Htel" placeholder="09"
								required pattern="[0-9]{10}" maxlength="10"  value="${hotel.tel}">
							</label>
						</div>
						<div>
						...
						<div>
						 ...
						 <label>鄉(鎮市區): <select name="Htown" id="ts" required
								onchange="putAddr('ts');">
								<option value="${hotel.townId}">${town}</option>
							</select>
							</label><br>
						</div>
						<div>

							<label>地址: <input type="text" name="Haddr" id="Haddr" value="${hotel.addr}"
