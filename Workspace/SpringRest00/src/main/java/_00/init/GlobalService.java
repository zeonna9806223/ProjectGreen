...
public class GlobalService {
	...
	public static final String DB_TYPE = DB_TYPE_SQLSERVER;
	
	public static String USERID = "";
	public static String USERID_MYSQL = "root";
	public static String USERID_SQLSERVER = "scott";
	
	public static String PASSWORD = "";
	public static String PASSWORD_MYSQL = "Do!ng123";
	public static String PASSWORD_SQLSERVER = "tiger";
	
	public static String JNDI_DB_NAME = "";
	public static final String JNDI_DB_NAME_MY = "java:comp/env/jdbc/customerMY";
	public static final String JNDI_DB_NAME_MS = "java:comp/env/jdbc/ProjectGreen";
	
	public static String DB_URL = "" ;
	public static final String DB_URL_SQLSERVER = "jdbc:sqlserver://" + GlobalService.host + ":1433;databaseName=ProjectGreen" ;
	public static final String DB_URL_MYSQL = "jdbc:mysql://localhost:3306/jspdb?useUnicode=yes&characterEncoding=utf8&serverTimezone=Asia/Taipei" ;	
	...
	static {
		if (DB_TYPE.equals(DB_TYPE_MYSQL)) {
			JNDI_DB_NAME = JNDI_DB_NAME_MY;
			DB_URL = DB_URL_MYSQL;
			USERID = USERID_MYSQL;
			PASSWORD = PASSWORD_MYSQL;
		} else if (DB_TYPE.equals(DB_TYPE_SQLSERVER)) {
			JNDI_DB_NAME = JNDI_DB_NAME_MS;
			DB_URL = DB_URL_SQLSERVER;
			USERID = USERID_SQLSERVER;
			PASSWORD = PASSWORD_SQLSERVER;
		}
		System.out.println("GlobalService, JNDI_DB_NAME=" + JNDI_DB_NAME);
		System.out.println("GlobalService, DB_URL=" + DB_URL);
		System.out.println("GlobalService, USERID=" + USERID);
		System.out.println("GlobalService, PASSWORD=" + PASSWORD);
	}
