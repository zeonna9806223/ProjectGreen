		...
		<div class="container-fluid">
			...
			<div class="owl-carousel owl-theme">
				<div class="item popular-item">
					<div class="thumb">
						<a href="${pageContext.request.contextPath}/restaurant/restaurantHome"><img src="social/img/popular_item_1.jpg" alt="" ></a>
				...
				<div class="item popular-item">
					<div class="thumb">
					<a href="${pageContext.request.contextPath}/restaurant/restaurantHome"><img src="social/img/popular_item_2.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Aenean dolor</h4>
				...
				<div class="item popular-item">
					<div class="thumb">
						<a href="${pageContext.request.contextPath}/restaurant/restaurantHome"><img src="social/img/popular_item_3.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Nunc at quam</h4>
				...
				<div class="item popular-item">
					<div class="thumb">
						<a href="${pageContext.request.contextPath}/restaurant/restaurantHome"><img src="social/img/popular_item_4.jpg" alt="" ></a>
						<div class="text-content">
				...
				<div class="item popular-item">
					<div class="thumb">
						<a href="${pageContext.request.contextPath}/restaurant/restaurantHome"><img src="social/img/popular_item_5.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Lorem ipsum</h4>
				...
				<div class="item popular-item" >
					<div class="thumb">
					<a href="${pageContext.request.contextPath}/restaurant/restaurantHome"><img src="social/img/popular_item_6.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Lorem ipsum</h4>
							<span>82 listings</span>
						</div>
...
<%-- 				<a href="${pageContext.request.contextPath}/edit/insert"> --%>
    ...
    <section class="pricing-tables" id="transportation">
        ...
        <a href="${pageContext.request.contextPath}/transportation/YouBike/YouBike.do">進去試試YouBike的ajax</a>
	<br>
	<a href="${pageContext.request.contextPath}/transportation/TaipeiMRT/TaipeiMRT.do">進去試試捷運</a>
	<br>
	<a href="${pageContext.request.contextPath}/comment/AccomComment/AccomComment.do">進去試試Comment新增功能</a>
