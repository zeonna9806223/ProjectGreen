				...
				<div class="col-md-10 col-md-offset-1">
					<div class="banner-caption">
						...
						<div class="blue-button">
							<a class="scrollTo" data-scrollTo="popular" href="#">Discover
								More</a>
						</div>
					</div>
		...
		<div class="container-fluid">
			...
			<div class="owl-carousel owl-theme">
				<div class="item popular-item">
					<div class="thumb">
						<a href="rSearchResult.jsp"><img src="img/popular_item_1.jpg" alt="" ></a>
				...
				<div class="item popular-item">
					<div class="thumb">
					<a href="rSearchResult.jsp"><img src="img/popular_item_2.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Aenean dolor</h4>
				...
				<div class="item popular-item">
					<div class="thumb">
						<a href="rSearchResult.jsp"><img src="img/popular_item_3.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Nunc at quam</h4>
				...
				<div class="item popular-item">
					<div class="thumb">
						<a href="rSearchResult.jsp"><img src="img/popular_item_4.jpg" alt="" ></a>
						<div class="text-content">
				...
				<div class="item popular-item">
					<div class="thumb">
						<a href="rSearchResult.jsp"><img src="img/popular_item_5.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Lorem ipsum</h4>
				...
				<div class="item popular-item" >
					<div class="thumb">
					<a href="rSearchResult"><img src="img/popular_item_6.jpg" alt="" ></a>
						<div class="text-content">
							<h4>Lorem ipsum</h4>
							<span>82 listings</span>
						</div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="featured-item">
						...
						<div class="down-content">
							...
							<p>Vestibulum id est eu felis vulputate hendrerit.
								Suspendisse dapibus turpis in dui pulvinar imperdiet. Nunc
								consectetur.</p>
							<div class="row">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="featured-item">
						...
						<div class="down-content">
							...
							<p>Mauris sit amet quam congue, pulvinar urna et, congue
								diam. Suspendisse eu lorem massa. Integer sit amet posuere.</p>
							<div class="row">
								<div class="col-md-6 first-button">
									<div class="text-button">
										<a href="#">Add to favorites</a>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="service-item">
						...
						<p>Etiam viverra nibh at lorem hendrerit porta non nec ligula.
				...
				<div class="col-md-4">
					<div class="service-item">
						...
						<p>Vivamus nec vehicula felis, sit amet convallis ex. Aenean
							dolor risus, rutrum at tincidunt eget, placerat ac mauris.</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="service-item">
						...
						<p>Praesent nec dui sed urna pharetra dapibus at ac elit.
							Aenean hendrerit metus leo, quis viverra purus condimentum nec.</p>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<div class="row">
							<div class="col-md-5 col-md-offset-1">
								<div class="left-content">
									...
									<p>
										...
										urna. Quisque sodales purus eu tellus fringilla.<br>
										<br>Mauris sit amet quam congue, pulvinar urna et, congue
										diam. Suspendisse eu lorem massa. Integer sit amet posuere
										tellus, id efficitur leo. In hac habitasse platea dictumst.
									</p>
									<div class="blue-button">
							...
							<div class="col-md-5">
								<div class="accordions">
									<ul class="accordion">
										<li><a>Ut in dapibus ipsum</a>
											<p>Nulla eget aliquet dui, vitae tincidunt nulla. Sed
												sagittis odio vitae auctor volutpat. In semper ex neque, ut
												hendrerit mauris rutrum eget. Integer consectetur neque eu
												enim dictum porta. Sed et risus ac sapien congue mattis.</p></li>
										<li><a>Vivamus ligula metus</a>
											<p>Integer vel augue arcu. Fusce ac turpis cursus,
												malesuada nulla quis, lobortis dui. Etiam blandit, erat
												efficitur rhoncus pellentesque, ligula turpis tempor dolor.</p>
										</li>
										<li><a>Suspendisse dapibus</a>
											<p>Nullam nibh lacus, rhoncus sit amet feugiat vel,
												porttitor sit amet nibh. Pellentesque feugiat justo nec enim
												pretium, sed faucibus lacus aliquam. Sed ac interdum mauris.</p>
										</li>
									</ul>
									<!-- / accordion -->
								</div>
	...
	<section id="video-container">
		...
		<div class="video-content">
			<div class="inner">
				...
				<a href="http://youtube.com" target="_blank"><i
