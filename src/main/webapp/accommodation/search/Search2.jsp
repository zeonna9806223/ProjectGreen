...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/hero-slider.css">
<link rel="stylesheet"
					...
					<div class="col-md-12">
						...
						<nav id="primary-nav" class="dropdown cf">
							<ul class="dropdown menu">
								...
								<li><a href="#">住宿選擇</a>
									<ul class="sub-menu">
										<li><a  href="${pageContext.request.contextPath}/index.jsp#accommodation">住宿查詢</a>
										<li><a  href="#">住宿資料編輯</a>
											<ul class="sub-menu">
                                                <li><a href="${pageContext.request.contextPath}/accommodation/edit/Insert2.jsp">新增</a></li>
                                                <li><a href="${pageContext.request.contextPath}/accommodation/edit/Update2.jsp">修改</a></li>
                                                <li><a href="${pageContext.request.contextPath}/accommodation/edit/Delete2.jsp">刪除</a></li>
                                            </ul>
										</li>
									</ul>
								</li>
						...
						<div class="col-md-4" style="padding:10px 6px; height: 450px;" >
							<div class="table-item">
								<div class="top-content">
									<h4  id="name${vs.index}" >${i.value.name}</h4>
									<h1>$${i.value.price}</h1>
									<span>最低價</span>
								</div>
								<ul>
									<li><b>地址:</b>&nbsp;${i.value.addr}</li>
									<li><b>電話:</b>&nbsp;${i.value.tel}</li>
			...
			<div class="row">
				<div class="col-md-5">
					<div class="about-veno">
						<div class="logo">
							<img
								src="${pageContext.request.contextPath}/img/footer_logo.png"
								alt="Venue Logo">
						</div>
