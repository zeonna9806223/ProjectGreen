				...
				<form name="form1 "
					...
					<fieldset >
						...
						<div>
							<label>姓名:<input type="text" name="Uname" id="name"
								placeholder="請輸入中文姓名" required value="" onblur="checkName()"
								onkeydown="keyDown('check1')"></label> <br><span id="check1"></span>
						</div>
						<div>
							<label>電話:<input type="tel" name="Utel" placeholder="09"
								required value="" pattern="[0-9]{10}" maxlength="10"></label><br>
							<span id="check2"></span>
						</div>

						<div>
							<label>電郵:<input type="email" name="Uemail"
								placeholder="請輸入電郵" required value=""></label><br>
						</div>
					...
					<fieldset>
						...
						<input type="reset"  class="button"> <input
							type="hidden" name="hidname" value="insert"> <input
